  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "luxury-mesh":
          "radial-gradient(ellipse 100% 80% at 50% 0%, rgba(212,175,55,0.07) 0%, transparent 60%), radial-gradient(ellipse 80% 50% at 80% 100%, rgba(184,134,11,0.05) 0%, transparent 50%)",
      },
      animation: {
